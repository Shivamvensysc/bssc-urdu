...
const BSSCForgotPassword: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] px-4 py-8 flex flex-col items-center justify-center gap-6">
      <div className="w-full max-w-[600px] bg-white border border-[#E1E5E3] rounded-lg px-6 pt-6 pb-8 md:px-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
        
        {/* Header */}
        <div className="text-center mb-6">
          <div className="flex items-center justify-center gap-2 mb-3">
            <div className="h-12 w-12 rounded-full bg-[#003A2B]/10 flex items-center justify-center">
              <Lock className="h-6 w-6 text-[#003A2B]" />
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                {...register("email")}
                type="email"
                className="w-full py-3 border border-[#B9C2BD] rounded-lg pl-11 pr-4 text-[15px] outline-none focus:border-[#003A2B] transition-colors"
          ...
          <div className="border border-[#E1E5E3] bg-[#F9FAFB] rounded-lg p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
              <div className="w-full sm:w-[180px] min-h-[55px] bg-white border border-[#D1D5DB] rounded-lg flex items-center justify-center overflow-hidden px-2">
                <div className="text-[#003A2B] text-2xl font-bold tracking-widest">
                  LBO53X
                </div>
              </div>
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full h-[48px] border border-[#B9C2BD] rounded-lg px-4 text-[15px] outline-none focus:border-[#003A2B] transition-colors"
                />
              </div>
            </div>
            {errors.captcha && (
...
export default BSSCForgotPassword;