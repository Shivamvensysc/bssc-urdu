...
const BSSCForgotPassword: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen px-4 pt-10 pb-10 flex flex-col items-center justify-center gap-6"
      style={{ background: PAPER }}
    >
      <div
        className="w-full max-w-[600px] border rounded-lg px-6 p-4 shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
      ...
      >
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            >
              <Lock className="h-6 w-6" style={{ color: INK }} />
            </div>
          </div>
          <h2
