...
// BASE_URL for API requests (Update this to match your backend environment configuration)
...
const BSSCForgotRegistration: React.FC = () => {
  ...
  const fetchCaptcha = async () => {
    try {
      ...
      setCaptcha("");
      setValue("captcha", ""); // Reset form input
      setError("");
    } catch (error: any) {
  ...
  const onSubmit = async (data: FormData) => {
    // Validate CAPTCHA before processing form submit
